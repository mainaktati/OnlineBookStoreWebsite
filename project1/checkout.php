   ...
   <form action="" method="post">
      ...
      <div class="flex">
        ...
        <div class="inputBox">
            ...
            <input type="tel" name="number" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" required title="Must follow the format 000-000-0000"required placeholder="enter your 10 digit phone number" >
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>House no.:</span>
            <input type="number" min="0" name="flat" required placeholder="e.g. house/flat no.">
         </div>
         <div class="inputBox">
